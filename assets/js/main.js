...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ── SCROLL ANIMATIONS ── */
  // Sur les pages sans animation (rgpd), rendre tous les éléments visibles immédiatement
  if (document.body.classList.contains("page-rgpd")) {
    document
    ...
    (entries) => {
      entries.forEach((e) => {
        ...
        const tick = (now) => {
          ...
          el.textContent =
            prefix +
            (Number.isInteger(end) ? Math.round(v) : v.toFixed(1)) +
            suffix;
