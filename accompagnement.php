...
$univers = [
  ...
  2 => [
    ...
    'image'    => content('accompagnement', 'u2_image',    'https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&q=80'),
    'points'   => [],
    'sous_parcours' => [
      [
        'icon'     => 'goal',
  ...
  3 => [
    ...
    'image'    => content('accompagnement', 'u3_image',    'https://images.unsplash.com/photo-1502780402662-acc01917949e?w=1200&q=80'),
    'points'   => [],
    'sous_parcours' => [
      [
        'icon'     => 'trending-up',
...
<section class="univers-section-full" id="<?= $u['id'] ?>"
  ...
  <div class="container">
    ...
    <?php foreach ($u['sous_parcours'] as $i => $sp):
      ...
      $delay  = $i > 0 ? ' delay-1' : '';
    ?>
    <div class="usf-grid <?= $layout ?> usf-sous <?= $i > 0 ? 'usf-sous-sep' : '' ?> fade-up<?= $delay ?>">
      ...
      <div class="usf-content">
        <div class="usf-sous-header">
          <i data-lucide="<?= $sp['icon'] ?>" style="stroke:<?= $u['couleur'] ?>;width:22px;height:22px"></i>
