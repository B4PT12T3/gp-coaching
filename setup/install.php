...
<head>
  ...
  <style>
    body { font-family: 'Segoe UI', sans-serif; background: #F7F3ED; color: #1E1A14; padding: 2rem; }
    .box { max-width: 600px; margin: 0 auto; background: #fff; border-radius: 8px; padding: 2rem; border: 1px solid rgba(30,26,20,.1); }
    h1 { font-size: 1.3rem; margin-bottom: 1.5rem; color: #1B2B4B; }
    .step { margin-bottom: 1rem; padding: .75rem 1rem; border-radius: 6px; font-size: .9rem; }
    ...
    input { width: 100%; padding: .6rem .9rem; border: 1px solid rgba(30,26,20,.2); border-radius: 6px; font-family: inherit; font-size: .9rem; margin-top: .3rem; }
    label { font-size: .75rem; font-weight: 600; text-transform: uppercase; letter-spacing: .08em; color: rgba(30,26,20,.6); display: block; margin-top: 1rem; }
    button { margin-top: 1.5rem; background: #1B2B4B; color: #fff; border: none; padding: .8rem 2rem; border-radius: 6px; cursor: pointer; font-size: .85rem; font-weight: 600; letter-spacing: .08em; text-transform: uppercase; }
    button:hover { background: #243659; }
...
$defaults = [
    ...
    ['accueil', 'citation_auteur',  '— Gilles, fondateur de GP Coaching', 'text', 'Auteur citation'],
