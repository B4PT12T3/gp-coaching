...
<form method="POST" enctype="multipart/form-data">
  ...
  <!-- Photo coach -->
  <div class="card">
    <div class="card-header"><span class="card-header-icon">◎</span><h2>Photo du coach</h2></div>
    <div class="card-body">
  ...
  <!-- Mon parcours -->
  <div class="card">
    <div class="card-header"><span class="card-header-icon">✦</span><h2>Mon Parcours, ma conviction</h2></div>
    <div class="card-body">
      <div class="field">
  ...
  <!-- Mission / Conviction -->
  <div class="card">
    <div class="card-header"><span class="card-header-icon">◈</span><h2>Mission & Conviction</h2></div>
    <div class="card-body">
      <div class="field">
