  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar-brand-sub {
      ...
      color: var(--gold-l); margin-top: .2rem; display: block;
    }
    .sidebar-badge {
    ...
    .sidebar-nav-icon { font-size: .85rem; width: 18px; text-align: center; }
    .sidebar-sep {
    ...
    .topbar-title { font-size: .82rem; color: var(--ink-60); font-weight: 400; }
    ...
    .topbar-view:hover { background: var(--gold-dim); }
    ...
    .card-header-icon { color: var(--gold); font-size: .9rem; }
    ...
    .field label {
      ...
      color: var(--ink-60); margin-bottom: .4rem;
    }
    ...
    .field-hint {
      font-size: .7rem; color: var(--ink-60);
    ...
    .btn-ghost { background: transparent; color: var(--ink-60); border: 1px solid var(--ink-20); }
    .btn-ghost:hover { background: var(--bg-alt); color: var(--ink); }
    .btn-danger { background: var(--red-dim); color: var(--red); border: 1px solid rgba(180,64,64,.2); }
    .btn-danger:hover { background: rgba(180,64,64,.18); }
    ...
    .alert-success { background: var(--green-dim); border: 1px solid rgba(58,125,68,.25); color: var(--green); }
    .alert-error   { background: var(--red-dim);   border: 1px solid rgba(180,64,64,.25); color: var(--red); }

    /* ── IMAGE PREVIEW ── */
    .img-preview {
      width: 100%; max-height: 180px; object-fit: cover;
      border-radius: var(--radius); border: 1px solid var(--ink-20);
      margin-bottom: .75rem;
    }
    .img-upload-zone {
    ...
    .img-upload-zone label { cursor: pointer; font-size: .82rem; color: var(--ink-60); }
    .img-upload-zone label strong { color: var(--gold); }

    /* ── DASHBOARD TILES ── */
    .tiles { display: grid; grid-template-columns: repeat(2,1fr); gap: 1rem; margin-bottom: 2rem; }
    .tile {
      background: var(--bg-card); border: 1px solid var(--ink-20);
    ...
    .tile:hover { box-shadow: 0 6px 24px rgba(27,43,75,.1); transform: translateY(-2px); }
    .tile-icon  { font-size: 1.4rem; }
    .tile-label { font-size: .72rem; font-weight: 600; letter-spacing: .1em; text-transform: uppercase; color: var(--ink-60); }
    .tile-title { font-size: .95rem; font-weight: 600; color: var(--ink); }
    .tile-desc  { font-size: .78rem; color: var(--ink-60); line-height: 1.5; }
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    <?php foreach ($admin_nav as $href => $item): ?>
      ...
      <a href="<?= $href === 'index.php' ? '../admin/index.php' : '../admin/' . $href ?>"
