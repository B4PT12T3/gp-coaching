...
<section class="rgpd-content">
    <div class="container rgpd-inner">
        ...
        <p>Dans le cadre du formulaire de contact, nous collectons les informations suivantes : nom, prénom, adresse email, numéro de téléphone (optionnel) et message. Ces données sont utilisées uniquement pour répondre à vos demandes.</p>
